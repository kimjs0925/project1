  ...
  const questions = [
    {
      key: 'sleep',
      label: '수면상태',
      prompt: '좋은 아침이야. 어젯밤에는 잠을 좀 편하게 잤어? 푹 잤는지, 조금 피곤한지 편하게 말해줘.',
      emptyPrompt: '잘 기억나지 않으면 괜찮아. 잘 잤어, 조금 피곤해, 잘 모르겠어처럼 말해도 돼.'
    },
    {
      key: 'breakfast',
      label: '아침밥 유무',
      prompt: '오늘 아침에는 뭘 좀 먹고 왔어? 안 먹었으면 안 먹었다고 말해도 괜찮아.',
      emptyPrompt: '아침을 못 먹었어도 괜찮아. 먹었어, 안 먹었어, 조금 먹었어처럼 말해줘.'
    },
    {
      key: 'special',
      label: '특이사항',
      prompt: '오늘 아침에 마음에 걸리는 일이나 특별히 선생님이 알아주면 좋을 일이 있어? 없으면 없었다고 이야기해도 돼.',
      emptyPrompt: '생각나는 일이 없으면 없었어라고 말해도 괜찮아.'
    },
    {
      key: 'mood',
      label: '아침기분',
      prompt: '지금 마음은 어떤 편이야? 기분 좋은지, 피곤한지, 걱정되는지 네 말로 들려줘.',
      emptyPrompt: '딱 맞는 말이 안 떠오르면 좋아, 보통이야, 피곤해처럼 짧게 말해도 좋아.'
    },
    {
      key: 'conflict',
      label: '친구와의 갈등상황',
      prompt: '친구와 지내면서 속상했거나 마음에 남은 일이 있었어? 아무 일도 없었으면 없었다고 말해도 괜찮아.',
